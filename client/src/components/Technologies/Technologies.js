    ...
    return (
        <div className={classes.mainContainer}>
            <Container className={classes.container}>
                <Typography variant="h3" className={classes.title}>Technologies We Use</Typography>
                <Carousel showIndicators={false} showThumbs={false} showStatus={false} emulateTouch={true} className={classes.carouselContainer}>
